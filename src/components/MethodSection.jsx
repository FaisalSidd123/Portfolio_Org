...
export default function MethodSection() {
  ...
  // GSAP animation for desktop circuit path
  useEffect(() => {
    if (isMobile) return;
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1200px", margin: "0 auto" }}>
        ...
        {/* Section Header */}
        <div style={{ textAlign: "center", marginBottom: isMobile ? "3rem" : "5rem", padding: "0 1.5rem" }}>
          <span style={{ fontFamily: "var(--font-mono)", color: "var(--accent-cyan)", fontSize: "0.9rem", letterSpacing: "0.15em" }}>
            {"// OPERATION PIPELINE"}
          </span>
          <h2 style={{ fontSize: isMobile ? "2.2rem" : "3rem", fontWeight: "800", marginTop: "1rem", textTransform: "uppercase" }}>
            THE GLLITCH METHOD
          </h2>
        </div>

        {/* Desktop Circuit View */}
        {!isMobile ? (
          ...
          /* Mobile Vertical Timeline Cards (visible on mobile < 1024px) */
